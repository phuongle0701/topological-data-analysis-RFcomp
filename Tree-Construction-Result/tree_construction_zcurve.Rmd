---
title: 'Tree Construction: Chaos Representation'
...
```{r}
DistanceMatrix = as.matrix(read.table('DistanceMatrix_Zcurve.txt', sep =','))
...
```{r}
png('tree_flu_upgma_chaosrep.png', width = 1200, height = 1500)
UMPGA_tree = upgma(MyDistanceMat)
plot(UMPGA_tree, main = "UMPGA:H1")
```
