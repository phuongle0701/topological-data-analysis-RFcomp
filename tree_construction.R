...
pathfile = "C:/Users/letph/Desktop/MatlabCode/Python Code"
setwd(dir = pathfile)
## loading the result: 
...
# Neighbor Joining is one of the most common ways to build a tree 
#using molecular data that's been converted 
#to sequences; its one of the options within BLAST.
